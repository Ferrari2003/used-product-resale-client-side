...
const CategoryCollectionCard = ({ items }) => {
        ...
        <div className="card w-96 bg-base-100 shadow-xl m-16 ">
            ...
            <div className="card-body">
                ...
                <div className="card-actions justify-end">
                    <button className="btn btn-primary  bg-gradient-to-r from-purple-500 font-bold to-pink-500"><FaArrowRight className='mr-4 text-2xl font-semibold'></FaArrowRight>Book Now</button>
                </div>
            </div>
        </div>
    );
